                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor='profile_picture' className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <div className='group/profile relative'>
                                <img src={editForm.profile_picture instanceof File 
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor='cover_photo' className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <div className='group/cover relative'>
                                <img className='w-80 h-40 rounded-lg bg-gradient-to-r 
                    ...
                    <div>
                        ...
                        <textarea rows={3} className='w-full p-3 border border-gray-200 rounded-lg'
                            placeholder='Please enter a short bio' value={editForm.bio}
                    ...
                    <div className='flex justify-end space-x-3 pt-6'>                        
                        <button onClick={()=> setShowEdit(false)} type='button' className='px-4 py-2 border border-gray-300 
                        rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer'>
                            Cancel
                        </button>
